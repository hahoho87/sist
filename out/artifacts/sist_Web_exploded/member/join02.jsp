...
body { margin : -5px auto; width:1000px;}
button { float :right; margin:5px;  position: relative; top:50px;}
ul { border-bottom : 3px solid black;}
ul li { width : 30%;display : inline-block; text-align: center;}
form { width : 800px; position: relative; left:100px; top:20px; }
